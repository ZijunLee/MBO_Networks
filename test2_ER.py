...
gt_HU_vec_new = gt_HU_vec.copy()
gt_HU_vec_old = gt_HU_vec_new.copy()

gt_LWP_vec_new = gt_MMBO_projection_vec.copy()
gt_LWP_vec_old = gt_LWP_vec_new.copy()

gt_B_vec_new = gt_B_vec.copy()
gt_B_vec_old = gt_B_vec_new.copy()
...
for _ in range(1):
    ...
    u_MMBO_projection_l_rw, num_iteration_MMBO_projection_l_rw, MMBO_projection_l_rw_modularity_list = MMBO_using_projection(m, degree_W_MMBO,  
                                            E_mmbo_rw, V_mmbo_rw, modularity_tol, u_init_LWP_sup, W_MMBO, gamma=gamma, stopping_condition='modularity') 
    ...
    u_mmbo_proj_B_sym, num_iteration_mmbo_proj_B_sym, MMBO_projection_B_sym_modularity_list = MMBO_using_projection(m, degree_W_B,  
                                            D_mmbo_B_sym, V_mmbo_B_sym, modularity_tol, u_init_B_sup, W_B, gamma=gamma, stopping_condition='modularity') 
    ...
    u_mmbo_proj_B_rw, num_iteration_mmbo_proj_B_rw, MMBO_projection_B_rw_modularity_list = MMBO_using_projection(m, degree_W_B,  
                                            D_mmbo_B_rw, V_mmbo_B_rw, modularity_tol, u_init_B_sup, W_B, gamma=gamma, stopping_condition='modularity')
    ...
    u_MMBO_using_finite_difference_sym, num_iteration_MMBO_using_finite_difference_sym, MMBO_using_finite_difference_sym_modularity_list = MMBO_using_finite_differendce(m,degree_W_MMBO, 
                                        E_mmbo_sym, V_mmbo_sym, modularity_tol, N_t,  u_init_LWP_sup, W_MMBO, gamma=gamma, stopping_condition='modularity') 
    ...
    u_MMBO_using_finite_difference_rw, num_iteration_MMBO_using_finite_difference_rw, MMBO_using_finite_difference_rw_modularity_list = MMBO_using_finite_differendce(m,degree_W_MMBO, 
                                        E_mmbo_rw, V_mmbo_rw, modularity_tol, N_t,  u_init_LWP_sup, W_MMBO, gamma=gamma, stopping_condition='modularity')
    ...
    u_MMBO_using_finite_difference_B_sym, num_iteration_MMBO_using_finite_difference_B_sym, MMBO_using_finite_difference_B_sym_modularity_list = MMBO_using_finite_differendce(m,degree_W_B, 
                                        D_mmbo_B_sym, V_mmbo_B_sym, modularity_tol, N_t,  u_init_B_sup, W_B, gamma=gamma, stopping_condition='modularity')
    ...
    u_MMBO_using_finite_difference_B_rw, num_iertation_MMBO_using_finite_difference_B_rw, MMBO_using_finite_difference_B_rw_modularity_list = MMBO_using_finite_differendce(m,degree_W_B, 
                                        D_mmbo_B_rw, V_mmbo_B_rw, modularity_tol, N_t,  u_init_B_sup, W_B, gamma=gamma, stopping_condition='modularity')
    time_MMBO_using_finite_difference_B_rw = time.time() - start_time_MMBO_using_finite_difference_B_rw
    time_MMBO_using_finite_difference_B_rw = time_eig_B_rw + time_initialize_u + time_MMBO_using_finite_difference_B_rw
...
average_ER_modularity_MMBO_projection_sym = sum_ER_modularity_MMBO_projection_l_sym / 1
...
average_time_MMBO_projection_rw = sum_time_MMBO_projection_rw / 1
average_num_iteration_MMBO_projection_rw = sum_num_iteration_MMBO_projection_l_rw / 1
#average_modularity_MMBO_projection_rw = sum_modularity_MMBO_projection_l_rw / 1
average_ER_modularity_MMBO_projection_rw = sum_ER_modularity_MMBO_projection_l_rw / 1
average_ARI_MMBO_projection_rw = sum_ARI_MMBO_projection_l_rw / 1
average_purify_MMBO_projection_rw = sum_purify_MMBO_projection_l_rw / 1
average_inverse_purify_MMBO_projection_rw = sum_inverse_purify_MMBO_projection_l_rw / 1
average_NMI_MMBO_projection_rw = sum_NMI_MMBO_projection_l_rw / 1
...
average_time_MMBO_projection_B_sym = sum_time_MMBO_projection_B_sym / 1
average_num_iter_MMBO_projection_B_sym = sum_num_repeat_mmbo_proj_B_sym / 1
#average_modularity_MMBO_projection_B_sym = sum_modularity_mmbo_proj_B_sym / 1
average_ER_modularity_MMBO_projection_B_sym = sum_ER_modularity_mmbo_proj_B_sym / 1
average_ARI_MMBO_projection_B_sym = sum_ARI_mmbo_proj_B_sym / 1
average_purify_MMBO_projection_B_sym = sum_purify_mmbo_proj_B_sym / 1
average_inverse_purify_MMBO_projection_B_sym = sum_inverse_purify_mmbo_proj_B_sym / 1
average_NMI_MMBO_projection_B_sym = sum_NMI_mmbo_proj_B_sym / 1
...
average_ER_modularity_MMBO_projection_B_rw = sum_ER_modularity_mmbo_proj_B_rw / 1
...
average_time_MMBO_inner_step = sum_time_MMBO_using_finite_difference_sym / 1
average_num_iter_MMBO_inner_step = sum_num_iteration_MMBO_using_finite_difference_sym / 1
#average_modularity_MMBO_inner_step = sum_modularity_MMBO_using_finite_difference_sym / 1
average_ER_modularity_MMBO_inner_step = sum_ER_modularity_MMBO_using_finite_difference_sym / 1
average_ARI_MMBO_inner_step = sum_ARI_MMBO_using_finite_difference_sym / 1
average_purify_MMBO_inner_step = sum_purify_MMBO_using_finite_difference_sym / 1
average_inverse_purify_MMBO_inner_step = sum_inverse_purify_MMBO_using_finite_difference_sym / 1
average_NMI_MMBO_inner_step = sum_NMI_MMBO_using_finite_difference_sym / 1
...
average_time_MMBO_using_finite_difference_rw = sum_time_MMBO_using_finite_difference_rw / 1
average_num_iter_MMBO_inner_step_rw = sum_num_iteration_MMBO_using_finite_difference_rw / 1
#average_modularity_MMBO_inner_step_rw = sum_modularity_MMBO_using_finite_difference_rw / 1
average_ER_modularity_MMBO_inner_step_rw = sum_ER_modularity_MMBO_using_finite_difference_rw / 1
average_ARI_MMBO_inner_step_rw = sum_ARI_MMBO_using_finite_difference_rw / 1
average_purify_MMBO_inner_step_rw = sum_purify_MMBO_using_finite_difference_rw / 1
average_inverse_purify_MMBO_inner_step_rw = sum_inverse_purify_MMBO_using_finite_difference_rw / 1
average_NMI_MMBO_inner_step_rw = sum_NMI_MMBO_using_finite_difference_rw / 1
...
average_time_MMBO_using_finite_difference_B_sym = sum_MMBO_using_finite_difference_B_sym / 1
average_num_iter_MMBO_inner_step_B_sym = sum_num_repeat_inner_nor_B_sym / 1
#average_modularity_MMBO_inner_step_B_sym = sum_modularity_mmbo_inner_B_sym / 1
average_ER_modularity_MMBO_inner_step_B_sym = sum_ER_modularity_mmbo_inner_B_sym / 1
average_ARI_MMBO_inner_step_B_sym = sum_ARI_mmbo_inner_B_sym / 1
average_purify_MMBO_inner_step_B_sym = sum_purify_mmbo_inner_B_sym / 1
average_inverse_purify_MMBO_inner_step_B_sym = sum_inverse_purify_mmbo_inner_B_sym / 1
average_NMI_MMBO_inner_step_B_sym = sum_NMI_mmbo_inner_B_sym / 1
...
average_time_MMBO_using_finite_difference_B_rw = sum_time_MMBO_using_finite_difference_B_rw / 1
average_num_iter_MMBO_inner_step_B_rw = sum_num_iertation_MMBO_using_finite_difference_B_rw / 1
#average_modularity_MMBO_inner_step_B_rw = sum_modularity_mmbo_inner_B_rw / 1
average_ER_modularity_MMBO_inner_step_B_rw = sum_ER_modularity_mmbo_inner_B_rw / 1
average_ARI_MMBO_inner_step_B_rw = sum_ARI_mmbo_inner_B_rw / 1
average_purify_MMBO_inner_step_B_rw = sum_purify_mmbo_inner_B_rw / 1
average_inverse_purify_MMBO_inner_step_B_rw = sum_inverse_purify_mmbo_inner_B_rw / 1
average_NMI_MMBO_inner_step_B_rw = sum_NMI_mmbo_inner_B_rw / 1
...
average_time_hu_mbo = sum_time_hu_sym / 1
average_num_iter_HU_sym = sum_num_iteration_HU_sym / 1
#average_modularity_hu_sym = sum_modularity_hu_sym / 1
average_ER_modularity_hu_sym = sum_ER_modularity_hu_sym / 1
average_ARI_hu_original_sym = sum_ARI_hu_original_sym / 1
average_purify_hu_original_sym = sum_purify_hu_original_sym / 1
average_inverse_purify_hu_original_sym = sum_inverse_purify_hu_original_sym / 1
average_NMI_hu_original_sym = sum_NMI_hu_original_sym / 1
...
average_time_hu_mbo = sum_time_hu_rw / 1
average_num_iter_HU_rw = sum_num_iter_HU_rw / 1
#average_modularity_hu_rw = sum_modularity_hu_rw / 1
average_ER_modularity_hu_rw = sum_ER_modularity_hu_rw / 1
average_ARI_hu_original_rw = sum_ARI_hu_original_rw / 1
average_purify_hu_original_rw = sum_purify_hu_original_rw / 1
average_inverse_purify_hu_original_rw = sum_inverse_purify_hu_original_rw / 1
average_NMI_hu_original_rw = sum_NMI_hu_original_rw / 1
