...
print("mmbo 2 with normalized & gamma = 1(K=11 and m=100):-- %.3f seconds --" % (time.time() - start_time_2_nor_1))
...
print('average mmbo 2 with normalized score(K=11 and m=100): ', modularity_2_nor_lf_qh)
print('average ARI for mmbo 2 with normalized score(K=11 and m=100): ', ARI_mbo_2_nor_1)
...
with open('MNIST_MMBO2_nor_LF_QH_11.csv', 'w', newline='') as csvfile:
