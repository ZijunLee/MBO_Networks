...
print("HU original MBO (K=11 and m=K):-- %.3f seconds --" % (time.time() - start_time_hu_original_1))
...
print('average modularity score for HU original MBO (K=11 and m=K): ', modu_hu_original_1)
print('average ARI for HU original MBO (K=11 and m=K): ', ARI_hu_original_1)
print('average purify for HU original MBO (K=11 and m=K): ', purify_hu_original_1)
print('average inverse purify for HU original MBO (K=11 and m=K): ', inverse_purify_hu_original_1)
print('average NMI for HU original MBO (K=11 and m=K): ', NMI_hu_original_1)
print('average AMI for HU original MBO (K=11 and m=K): ', AMI_hu_original_1)
