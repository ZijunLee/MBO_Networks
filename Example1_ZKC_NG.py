...
for _ in range(20):
    ...
    time_HU_sym = time_eig_hu_l_sym + time_initialize_u + time_HU_sym
    ...
    ARI_hu_sym = adjusted_rand_score(u_hu_sym_label, gt_array)
    purify_hu_sym = purity_score(gt_array, u_hu_sym_label)
    inverse_purify_hu_sym = inverse_purity_score(gt_array, u_hu_sym_label)
    NMI_hu_sym = normalized_mutual_info_score(gt_array, u_hu_sym_label)
    ...
    time_HU_rw = time_eig_hu_l_rw + time_initialize_u + time_HU_rw
    ...
    ARI_Hu_rw = adjusted_rand_score(u_hu_label_rw, gt_array)
    purify_Hu_rw = purity_score(gt_array, u_hu_label_rw)
    inverse_purify_Hu_rw = inverse_purity_score(gt_array, u_hu_label_rw)
    NMI_Hu_rw = normalized_mutual_info_score(gt_array, u_hu_label_rw)
...
print('average_purify_MMBO_projection_B_rw: ', average_purify_MMBO_projection_B_rw)
