...
# Example 3: Stochastic block model (SBM)

# Parameter setting
num_communities = 10          # K = 5/10/15
m = 1 * num_communities
tol = 1e-4
N_t = 3
N = 3000
...
eig_val_boyd_sym, eig_vec_boyd_sym = eigsh(sym_graph_laplacian, k=5*num_communities, which='SA')
time_eig_boyd_l_sym = time.time() - start_time_boyd_l_sym


start_time_boyd_l_rw = time.time()
eig_val_boyd_rw, eig_vec_boyd_rw = eigsh(random_walk_lap, k=5*num_communities, which='SA')
time_eig_boyd_l_rw = time.time() - start_time_boyd_l_rw
...
for _ in range(20):
    ...
    # Restrict each cluster to have the same number of nodes at initialization
    ...
    start_time_boyd_l_sym = time.time()
    u_boyd_vector_l_sym, num_iteration_boyd_l_sym, boyd_sym_modularity_list = boyd_mbo_method(num_communities, degree,  
                                        eig_val_boyd_sym, eig_vec_boyd_sym, tol,u_init, adj_mat_nparray, gamma=gamma)
    time_boyd_sym = time.time() - start_time_boyd_l_sym
    time_boyd_sym = time_eig_boyd_l_sym + time_initialize_u + time_boyd_sym
    ...
    modularity_boyd_l_sym = skn.clustering.modularity(adj_mat_nparray ,u_boyd_l_sym_label,resolution=gamma)
    ARI_boyd_l_sym = adjusted_rand_score(u_boyd_l_sym_label, gt_membership)
    purify_boyd_l_sym = purity_score(gt_membership, u_boyd_l_sym_label)
    inverse_purify_boyd_l_sym = inverse_purity_score(gt_membership, u_boyd_l_sym_label)
    NMI_boyd_l_sym = normalized_mutual_info_score(gt_membership, u_boyd_l_sym_label)
    ...
    start_time_boyd_l_rw = time.time()
    u_boyd_l_rw, num_iteration_boyd_l_rw, boyd_rw_modularity_list = boyd_mbo_method(num_communities, degree,  
                                        eig_val_boyd_sym, eig_vec_boyd_rw, tol, u_init, adj_mat_nparray, gamma=gamma)
    time_boyd_rw = time.time() - start_time_boyd_l_rw
    time_boyd_rw = time_eig_boyd_l_rw + time_initialize_u + time_boyd_rw
    ...
    modularity_boyd_l_rw = skn.clustering.modularity(adj_mat_nparray ,u_boyd_l_rw_label,resolution=gamma)
    ARI_boyd_l_rw = adjusted_rand_score(u_boyd_l_rw_label, gt_membership)
    purify_boyd_l_rw = purity_score(gt_membership, u_boyd_l_rw_label)
    inverse_purify_boyd_l_rw = inverse_purity_score(gt_membership, u_boyd_l_rw_label)
    NMI_boyd_l_rw = normalized_mutual_info_score(gt_membership, u_boyd_l_rw_label)
    ...
    modularity_MMBO_using_finite_difference_sym = skn.clustering.modularity(adj_mat_nparray,u_MMBO_using_finite_difference_sym,resolution=gamma)
    ARI_MMBO_using_finite_difference_sym = adjusted_rand_score(u_MMBO_using_finite_difference_sym, gt_membership)
    purify_MMBO_using_finite_difference_sym = purity_score(gt_membership, u_MMBO_using_finite_difference_sym)
    inverse_purify_MMBO_using_finite_difference_sym1 = inverse_purity_score(gt_membership, u_MMBO_using_finite_difference_sym)
    NMI_MMBO_using_finite_difference_sym = normalized_mutual_info_score(gt_membership, u_MMBO_using_finite_difference_sym)
    ...
    modularity_MMBO_using_finite_difference_rw = skn.clustering.modularity(adj_mat_nparray,u_MMBO_using_finite_difference_rw,resolution=gamma)
    ARI_MMBO_using_finite_difference_rw = adjusted_rand_score(u_MMBO_using_finite_difference_rw, gt_membership)
    purify_MMBO_using_finite_difference_rw = purity_score(gt_membership, u_MMBO_using_finite_difference_rw)
    inverse_purify_MMBO_using_finite_difference_rw = inverse_purity_score(gt_membership, u_MMBO_using_finite_difference_rw)
    NMI_MMBO_using_finite_difference_rw = normalized_mutual_info_score(gt_membership, u_MMBO_using_finite_difference_rw)
    ...
    time_MMBO_using_finite_difference_B_sym = time.time() - start_time_MMBO_using_finite_difference_B_sym
    ime_MMBO_using_finite_difference_B_sym = time_eig_l_mix_B_sym + time_initialize_u + time_MMBO_using_finite_difference_B_sym
    ...
    modularity_MMBO_using_finite_difference_B_sym = skn.clustering.modularity(adj_mat_nparray,u_MMBO_using_finite_difference_B_sym,resolution=gamma)
    ARI_MMBO_using_finite_difference_B_sym = adjusted_rand_score(u_MMBO_using_finite_difference_B_sym, gt_membership)
    purify_MMBO_using_finite_difference_B_sym = purity_score(gt_membership, u_MMBO_using_finite_difference_B_sym)
    inverse_purify_MMBO_using_finite_difference_B_sym = inverse_purity_score(gt_membership, u_MMBO_using_finite_difference_B_sym)
    NMI_MMBO_using_finite_difference_B_sym = normalized_mutual_info_score(gt_membership, u_MMBO_using_finite_difference_B_sym)

    sum_MMBO_using_finite_difference_B_sym += time_MMBO_using_finite_difference_B_sym
    ...
    modularity_MMBO_using_finite_difference_B_rw = skn.clustering.modularity(adj_mat_nparray,u_MMBO_using_finite_difference_B_rw,resolution=1)
    ARI_MMBO_using_finite_difference_B_rw = adjusted_rand_score(u_MMBO_using_finite_difference_B_rw, gt_membership)
    purify_MMBO_using_finite_difference_B_rw = purity_score(gt_membership, u_MMBO_using_finite_difference_B_rw)
    inverse_purifyMMBO_using_finite_difference_B_rw = inverse_purity_score(gt_membership, u_MMBO_using_finite_difference_B_rw)
    NMI_MMBO_using_finite_difference_B_rw = normalized_mutual_info_score(gt_membership, u_MMBO_using_finite_difference_B_rw)
    ...
    sum_ARI_mmbo_inner_B_rw += ARI_MMBO_using_finite_difference_B_rw
...
#    louvain_cluster = len(np.unique(louvain_array))
    #print('louvain_cluster', louvain_cluster)

    #print('louvain_partition_list', louvain_partition_list)
