...
#    modularity_CNM = skn.clustering.modularity(W, assignment,resolution=0.5)
#    ARI_CNM = adjusted_rand_score(assignment, gt_labels)
#    purify_CNM = purity_score(gt_labels, assignment)
#    inverse_purify_CNM = inverse_purity_score(gt_labels, assignment)
#    NMI_CNM = normalized_mutual_info_score(gt_labels, assignment)
