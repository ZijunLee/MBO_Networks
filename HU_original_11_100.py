...
print("HU original MBO (K=11):-- %.3f seconds --" % (time.time() - start_time_hu_original_1))
...
print('average modularity score for HU original MBO (K=11): ', modu_hu_original_1)
print('average ARI for HU original MBO (K=11): ', ARI_hu_original_1)
print('average purify for HU original MBO (K=11): ', purify_hu_original_1)
